...
- **Hosting Environment:** either a Node.js-capable platform with SSL or a self-hosted setup. For self-hosting, refer to my [nodejs-server](https://github.com/ZicNik/nodejs-server?tab=readme-ov-file#getting-started) repository for guidance.
